class OccasionsController < ApplicationController
  ...
  def destroy
    ...
    respond_to do |format|
      format.html { redirect_to occasions_path, status: :see_other, notice: "Occasion was successfully destroyed." }
  ...
  private
    ...
    def set_occasion
      @occasion = Occasion.find(params.expect(:id))
    end

    # Only allow a list of trusted parameters through.
    def occasion_params
      params.expect(occasion: [ :title, :weekday ])
    end
end
